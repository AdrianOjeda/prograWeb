...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="es">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="{{ asset ('Tema/Windmill/css/tailwind.output.css') }}" />
    <script
  ...
  <body>
    ...
    >
      <!-- Desktop sidebar -->
       @include('layouts.sidebar-desktop-alumno')
      
      <!-- Mobile sidebar -->
      <!-- Backdrop -->
      @include('layouts.sidebar-mobile-alumno')
      <div class="flex flex-col flex-1">
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
          ...
          >
            ...
            <!-- Search input -->
            @include('layouts.search-input-alumno')
